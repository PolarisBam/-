...
$(function() {
  var bookmark = {
    data: [{
      ...
      name: '方包博客',
      link: 'http://fang1688.cn',
      box_shadow: '#00A0E9',
      icon: 'img/fbblog.jpg',
    },
    {
      name: '知识学堂',
      link: 'http://wp.fang1688.cn',
      box_shadow: '#00A0E9',
      icon: 'img/zhishixuetang.jpg',
    }]
  }
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "星宇主页 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "星宇主页 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "星宇主页 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "星宇主页 | Stay up late again";
}
//title问候语结束
